...
Process {
    try 
    {
        ...
        NVR_NAVScripts\Export-NAVApplicationObject -Server $Server -Database $Database -Username 'sa' -Password $Password -Path $ResultFob -Force -Filter 'Compiled=1' -NavIde $NavIde -LogFolder $LogFolder
