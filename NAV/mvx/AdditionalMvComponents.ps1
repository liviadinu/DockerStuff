...
if(!$isRestarting){
	$serviceTierFolder = (Get-Item "C:\Program Files\Microsoft Dynamics NAV\110\Service").FullName
	...
	$roleTailoredClientFolder = (Get-Item "C:\Program Files (x86)\Microsoft Dynamics NAV\110\RoleTailored Client").FullName
