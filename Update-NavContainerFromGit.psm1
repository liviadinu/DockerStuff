...
$version = '2017'
$tag = Get-NavContainerImageName -containerName test2018
[bool]$val = $tag -like '*2018*'
if ($val) {$version = '2018'}

$command = "C:\run\mvx\Scripts$version\Update-NAVApplicationFromTxt.ps1 -Files C:\run\mvx\repo -Server $dbServer -Database $dbName -Password $dbPass -LogFolder C:\run\mvx\"
